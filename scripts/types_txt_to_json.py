...
Usage:
  python scripts/types_txt_to_json.py <input_types.txt> <output_types.json>
...
def main():
    if len(sys.argv) != 3:
        print("Usage: python scripts/types_txt_to_json.py <input_types.txt> <output_types.json>", file=sys.stderr)
        sys.exit(2)
